...
function InstructionScreen1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of InstructionScreen1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AUTResponseRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of AUTResponseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function AddRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of AddComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function InstructionScreen2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of InstructionScreen2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function CheckResponseRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of CheckResponseComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ChangeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ChangeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function InstructionScreen3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of InstructionScreen3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function InstructionScreen4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of InstructionScreen4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function CompareRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of CompareComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function RJTRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of RJTComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
